...
class Building:
    ...
    def __init__(self, x, y, name):
        ...
        title.write(str(self.health), align="center", font=["Arial", 16, "bold"])
        self.title = title
    ...
    def get_pic_name(self):
        ...
        if self.health < self.INITIAL_HEALTH * 0.6:
    ...
    def draw(self):
        ...
        if self.health != self.title_health:
            self.title_health = self.health
            self.title.clear()
            self.title.write(str(self.title_health), align="center", font=["Arial", 16, "bold"])
...
def check_impact():
    ...
    for enemy_missile in enemy_missiles:
        ...
        for building in buildings:
            if enemy_missile.distance(building.x, building.y) < enemy_missile.radius * 5:
                building.health -= 25
